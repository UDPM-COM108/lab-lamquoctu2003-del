...
//BÀI 5: XÂY DỰNG CHƯƠNG TRÌNH TÍNH CHU VI VÀ DIỆN TÍCH TAM GIÁC VUÔNG
#include <math.h> // Thư viện để dùng hàm sqrt()
    float a, b, c, chuVi, dienTich;
    // Nhập 2 cạnh góc vuông
    printf("Nhap canh goc vuong thu nhat a: ");
    scanf("%f", &a);
    printf("Nhap canh goc vuong thu hai b: ");
    scanf("%f", &b);
    // Tính cạnh huyền
    c = sqrt(a * a + b * b);
    // Tính chu vi và diện tích
